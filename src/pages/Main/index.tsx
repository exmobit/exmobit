      ...
      <div className="page-wrapper">
        ...
        >
            ...
            <div className="navbar_menu-container">
              ...
              <div className="navbar_menu-footer">
                ...
                <div className="text-size-small text-color-neutral-400">
                  Topper is an Uphold brand © 2023 All Rights Reserved
                </div>
              </div>
            </div>
          </nav>
          <div className="navbar_container">
            <a
              href="/"
              id="w-node-_47a7ce9a-d8fe-4ab8-d1a4-4f305ad2f151-5ad2f138"
              aria-current="page"
              className="navbar_logo-link w-nav-brand w--current"
              aria-label="home"
            >
              <div className="visually-hidden">Topper by Uphold</div>
            ...
            <div className="navbar_nav">
              <div className="navbar_nav-links">
                <a
                  id="blog-link"
                  data-w-id="47a7ce9a-d8fe-4ab8-d1a4-4f305ad2f15c"
                  href="/blog"
          ...
          <section className="section_main-header">
            <div className="section_main-header-grid">
              ...
              <div className="section_main-header-content-wrapper">
                <h1
                  data-w-id="d135f2f4-5396-d732-6aeb-c1b7859b42ff"
                  className="section_main-header-title"
                >
                ...
                <div
                  ...
                  data-w-id="2d2f6cbc-6f39-d6ef-6a86-4028b0febaa3"
                  className="section_main-header-cta"
                >
                  <a
                    href="#"
                ...
                <div
                  data-w-id="7a53d417-7728-5452-7515-8d0228e942e2"
                  className="section_main-header-description-wrapper"
                >
                  ...
                  <div className="section_main-header-description-item">
                    ...
                    <div className="section_main-header-description">
                      Select from 200+ cryptocurrencies
                      <br />
                    </div>
                  </div>
                  <div className="section_main-header-description-item">
            ...
            <section className="section-group_one">
              <div className="section-one_wrapper">
                <div className="section-one_grid">
                  <h2
                    id="w-node-_0984df9f-969c-99dc-e2d1-394e13c5e058-4933b8fe"
                    className="section-one_title"
                  >
                    Where
